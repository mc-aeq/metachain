...
namespace MCP02
{
	...
	uint16_t SubChain::init( char caChainName[MAX_CHAINNAME_LENGTH], char caPoP[MAX_POP_NAME] )
	{
		...
		m_pPoP = MetaChain::getInstance().getStorageManager()->getSubChainManager()->getPoPInstance(caPoP);
