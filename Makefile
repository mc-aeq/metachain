...
pkgdatadir = $(datadir)/metachain
pkgincludedir = $(includedir)/metachain
pkglibdir = $(libdir)/metachain
pkglibexecdir = $(libexecdir)/metachain
...
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -D_LINUX -D_DEBUG
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -g -O2 -g3 -O0
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"metachain\" -DPACKAGE_TARNAME=\"metachain\" -DPACKAGE_VERSION=\"1\" -DPACKAGE_STRING=\"metachain\ 1\" -DPACKAGE_BUGREPORT=\"office@trustchaintechnologies.io\" -DPACKAGE_URL=\"\" -DPACKAGE=\"metachain\" -DVERSION=\"1\" -DHAVE_CXX11=1 -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_STRING=1 -DHAVE_IOSTREAM=1 -DHAVE_TIME_H=1 -DHAVE_FSTREAM=1 -DHAVE_VECTOR=1 -DHAVE_MAP=1 -DHAVE_STDINT_H=1 -DHAVE_LIMITS=1 -DHAVE_ERRNO_H=1 -DHAVE_ATOMIC=1 -DHAVE_CHRONO=1 -DHAVE_MUTEX=1 -DHAVE_THREAD=1 -DHAVE_QUEUE=1 -DHAVE_ENDIAN_H=1 -DHAVE_BYTESWAP_H=1 -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_UNISTD_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_SELECT_H=1 -DHAVE_SYS_PRCTL_H=1 -DHAVE_PTHREAD_PRIO_INHERIT=1 -DHAVE_PTHREAD=1 -DHAVE_DECL_LE16TOH=1 -DHAVE_DECL_LE32TOH=1 -DHAVE_DECL_LE64TOH=1 -DHAVE_DECL_HTOLE16=1 -DHAVE_DECL_HTOLE32=1 -DHAVE_DECL_HTOLE64=1 -DHAVE_DECL_BE16TOH=1 -DHAVE_DECL_BE32TOH=1 -DHAVE_DECL_BE64TOH=1 -DHAVE_DECL_HTOBE16=1 -DHAVE_DECL_HTOBE32=1 -DHAVE_DECL_HTOBE64=1 -DHAVE_DECL_BSWAP_16=1 -DHAVE_DECL_BSWAP_32=1 -DHAVE_DECL_BSWAP_64=1 -DHAVE_DECL_DAEMON=1 -DHAVE_MSG_NOSIGNAL=1 -DHAVE_MSG_DONTWAIT=1 -DHAVE_MALLOC_INFO=1 -DHAVE_BOOST=/\*\*/ -DHAVE_BOOST_CHRONO=/\*\*/ -DHAVE_BOOST_DATE_TIME=/\*\*/ -DHAVE_BOOST_IOSTREAMS=/\*\*/ -DHAVE_BOOST_LOCALE=/\*\*/ -DHAVE_BOOST_REGEX=/\*\*/ -DHAVE_BOOST_SIGNALS=/\*\*/ -DHAVE_BOOST_THREAD=/\*\*/ -DHAVE_BOOST_SYSTEM=/\*\*/ -DHAVE_BOOST_FILESYSTEM=/\*\*/
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
